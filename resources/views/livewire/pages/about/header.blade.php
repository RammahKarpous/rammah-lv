<header
	...
	<section class="flex flex-col items-center -translate-y-24">
		...
		<img 
			...
			class="z-10 w-40 mx-auto mb-3 rounded-full shadow-xl xl:-mb-10">
			
		<h1 class="text-5xl font-bold uppercase sm:text-6xl md:text-[90px] xl:text-[130px] text-center text-[#191C29] max-w-screen-xl">
			Full stack <br> web developer</h1>

		<p class="text-xl font-bold tracking-[0.3em] text-center uppercase">Hello! 👋🏾 I'm Rammah</p>
	</section>
