<section class="flex flex-col items-center justify-center gap-5 mt-[300px] md:mt-[400px]" id="technologies">
    <h4 class="text-xl font-semibold tracking-[0.5em] uppercase font-quicksand">{{ __('My toolbox') }}</h4>
